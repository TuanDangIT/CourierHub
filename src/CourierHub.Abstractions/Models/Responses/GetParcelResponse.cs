...
public record class GetParcelResponse
{
    ...
    /// <summary>
    /// The list of parcels to be shipped. Each parcel includes its dimensions and weight. A shipment can consist of one or more parcels, depending on the courier provider's capabilities.
    /// </summary>
    public required IEnumerable<Parcel> Parcels { get; init; }

    /// <summary>
    /// Insurance details for the parcel, if applicable. This is optional.
    /// </summary>
    public Insurance? Insurance { get; init; }

    /// <summary>
    /// Cash on delivery details for the parcel, if applicable. This is optional.
    /// </summary>
    ...
    /// <summary>
    /// Pick up point code for pickup, if applicable. This is optional. The specific format and meaning of this code are determined by each courier provider.
    /// </summary>
    public string? PickupPointCode { get; init; }

    /// <summary>
    /// Drop-off point code for drop-off, if applicable. This is optional. The specific format and meaning of this code are determined by each courier provider.
    /// </summary>
    public string? DropoffPointCode { get; init; }

    /// <summary>
    /// Sending method or delivery option for the parcel. The specific values and their meanings are determined by each courier provider. This field is optional.
    /// </summary>
    ...
    /// <summary>
    /// Is Return shipment. Indicates whether the parcel is being sent as a return to the sender. This is optional. If true, it signifies that the parcel is intended to be returned to the sender rather than delivered to a recipient. The specific handling of return shipments is determined by each courier provider.
    /// </summary>
    public bool? IsReturn { get; init; }

    /// <summary>
    /// Additional comments, if applicable. This is optional.
    /// </summary>
