...
/// </summary>
internal sealed class DpdCreateParcelRequest
{
    /// <summary>
    ...
    /// </summary>
    public required IEnumerable<DpdCreateParcelRequestPackage> Packages { get; init; }
}

/// <summary>
/// DPD specific representation of a package, used in DPD API requests and responses.
/// </summary>
internal sealed class DpdCreateParcelRequestPackage
{
    /// <summary>
    /// Sender information.
    /// </summary>
    public required DpdSenderOrReceiver Sender { get; init; }

    /// <summary>
    /// Receiver information. This property is required for standard shipments where the sender provides the receiver's details. However, for PUDO (Pick-Up Drop-Off) shipments, this property may be null, and the receiver information will instead be provided in the DpdPudoReceiver property of the service attributes.
    /// </summary>
    public DpdSenderOrReceiver? Receiver { get; init; }

    /// <summary>
    /// Receiver information. This property is specifically used for PUDO (Pick-Up Drop-Off) shipments.
    /// </summary>
    public DpdPudoReceiver? PudoReceiver { get; init; }

    /// <summary>
    /// Parcels to be shipped. Each parcel includes its dimensions and weight.
    /// </summary>
    public required IEnumerable<DpdCreateParcelRequestParcel> Parcels { get; init; }
    ...
    /// </summary>
    public IEnumerable<DpdService>? Service { get; init; }
}

/// <summary>
/// Dpd specific representation of a parcel, used in Dpd API requests and responses.
/// </summary>
internal sealed class DpdCreateParcelRequestParcel
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>This customer data 1 might be displayed on the final label for DPD.</remarks>
    public string? CustomerData1 { get; init; }

    /// <summary>
    /// Additional customer-specific data for the parcel, if applicable. This is an optional field that can be used to provide any extra information or notes related to the parcel.
    /// </summary>
    /// <remarks>This customer data 2 might be displayed on the final label for DPD. Smaller chance (even unlikely) than for first customer data.</remarks>
    public string? CustomerData2 { get; init; }

    /// <summary>
    /// Additional customer-specific data for the parcel, if applicable. This is an optional field that can be used to provide any extra information or notes related to the parcel.
    /// </summary>
    /// <remarks>This customer data 3 might be displayed on the final label for DPD. Smaller chance (even unlikely) than for first customer data.</remarks>
