...
public sealed class CreateParcelResponse
{
    ...
    /// </summary>
    public required IEnumerable<CreateParcelResponsePackage> Packages { get; init; }
...
/// </summary>
public sealed class CreateParcelResponsePackage
{
    /// <summary>
    ...
    /// </summary>
    public required IEnumerable<CreateParcelResponseParcel> Parcels { get; init; }
}
...
/// </summary>
public sealed class CreateParcelResponseParcel
{
    /// <summary>
